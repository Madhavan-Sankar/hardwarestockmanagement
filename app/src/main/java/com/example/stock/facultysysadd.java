...
public class facultysysadd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facultysysadd);
        Window window;
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String id,name,monitor,keyboard,mouse,cpu;
                ...
                if(id.equals("") || name.equals("") || monitor.equals("") || keyboard.equals("") || mouse.equals("") || cpu.equals(""))
                {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            data[4] = mouse;
                            data[5] = cpu;
                            PutData putData = new PutData(ipaddress+"/facultysysadd.php", "POST", field, data);
                            if (putData.startPut()) {
                                if (putData.onComplete()) {
                                    ...
                                    if (result.equals("Faculty Details Update Success")){
                                        ...
                                        Intent ii = new Intent(facultysysadd.this, admin.class);
                                        ii.putExtras(bundle);
                                        startActivity(ii);
                                        //finish();
                                    }
                                    else{
                                        Toast.makeText(getApplicationContext(),result+"\nFaculty ID already esists or stock not available!!",Toast.LENGTH_LONG).show();
                                    }
                                }
                            }
    ...
    private void populateListView (){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, ipaddress+"/stockread.php",
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                progressBar.setVisibility(View.GONE);
                Toast.makeText(facultysysadd.this, error.toString(),Toast.LENGTH_LONG).show();

            }
        });

        Volley.newRequestQueue(facultysysadd.this).add(stringRequest);
